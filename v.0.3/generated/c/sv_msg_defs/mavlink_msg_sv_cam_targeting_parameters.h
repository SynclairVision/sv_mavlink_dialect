...
#define MAVLINK_MSG_ID_SV_CAM_TARGETING_PARAMETERS_LEN 52
#define MAVLINK_MSG_ID_SV_CAM_TARGETING_PARAMETERS_MIN_LEN 52
#define MAVLINK_MSG_ID_40007_LEN 52
#define MAVLINK_MSG_ID_40007_MIN_LEN 52

#define MAVLINK_MSG_ID_SV_CAM_TARGETING_PARAMETERS_CRC 5
#define MAVLINK_MSG_ID_40007_CRC 5

#define MAVLINK_MSG_SV_CAM_TARGETING_PARAMETERS_FIELD_STREAM_NAME_LEN 16
...
#define MAVLINK_MESSAGE_INFO_SV_CAM_TARGETING_PARAMETERS { \
    ...
    13, \
    {  { "stream_name", NULL, MAVLINK_TYPE_CHAR, 16, 32, offsetof(mavlink_sv_cam_targeting_parameters_t, stream_name) }, \
         { "cam_id", NULL, MAVLINK_TYPE_UINT8_T, 0, 48, offsetof(mavlink_sv_cam_targeting_parameters_t, cam_id) }, \
         { "targeting_mode", NULL, MAVLINK_TYPE_UINT8_T, 0, 49, offsetof(mavlink_sv_cam_targeting_parameters_t, targeting_mode) }, \
         { "euler_delta", NULL, MAVLINK_TYPE_UINT8_T, 0, 50, offsetof(mavlink_sv_cam_targeting_parameters_t, euler_delta) }, \
         ...
         { "lock_flags", NULL, MAVLINK_TYPE_UINT8_T, 0, 51, offsetof(mavlink_sv_cam_targeting_parameters_t, lock_flags) }, \
                               ...
                               const char *stream_name, uint8_t cam_id, uint8_t targeting_mode, uint8_t euler_delta, float yaw, float pitch, float roll, uint8_t lock_flags, float x_offset, float y_offset, float target_latitude, float target_longitude, float target_altitude)
{
    ...
    _mav_put_uint8_t(buf, 48, cam_id);
    _mav_put_uint8_t(buf, 49, targeting_mode);
    _mav_put_uint8_t(buf, 50, euler_delta);
    _mav_put_uint8_t(buf, 51, lock_flags);
    _mav_put_char_array(buf, 32, stream_name, 16);
...
{
    return mavlink_msg_sv_cam_targeting_parameters_pack(system_id, component_id, msg, sv_cam_targeting_parameters->stream_name, sv_cam_targeting_parameters->cam_id, sv_cam_targeting_parameters->targeting_mode, sv_cam_targeting_parameters->euler_delta, sv_cam_targeting_parameters->yaw, sv_cam_targeting_parameters->pitch, sv_cam_targeting_parameters->roll, sv_cam_targeting_parameters->lock_flags, sv_cam_targeting_parameters->x_offset, sv_cam_targeting_parameters->y_offset, sv_cam_targeting_parameters->target_latitude, sv_cam_targeting_parameters->target_longitude, sv_cam_targeting_parameters->target_altitude);
}
...
{
    return mavlink_msg_sv_cam_targeting_parameters_pack_chan(system_id, component_id, chan, msg, sv_cam_targeting_parameters->stream_name, sv_cam_targeting_parameters->cam_id, sv_cam_targeting_parameters->targeting_mode, sv_cam_targeting_parameters->euler_delta, sv_cam_targeting_parameters->yaw, sv_cam_targeting_parameters->pitch, sv_cam_targeting_parameters->roll, sv_cam_targeting_parameters->lock_flags, sv_cam_targeting_parameters->x_offset, sv_cam_targeting_parameters->y_offset, sv_cam_targeting_parameters->target_latitude, sv_cam_targeting_parameters->target_longitude, sv_cam_targeting_parameters->target_altitude);
}
...
{
    return mavlink_msg_sv_cam_targeting_parameters_pack_status(system_id, component_id, _status, msg,  sv_cam_targeting_parameters->stream_name, sv_cam_targeting_parameters->cam_id, sv_cam_targeting_parameters->targeting_mode, sv_cam_targeting_parameters->euler_delta, sv_cam_targeting_parameters->yaw, sv_cam_targeting_parameters->pitch, sv_cam_targeting_parameters->roll, sv_cam_targeting_parameters->lock_flags, sv_cam_targeting_parameters->x_offset, sv_cam_targeting_parameters->y_offset, sv_cam_targeting_parameters->target_latitude, sv_cam_targeting_parameters->target_longitude, sv_cam_targeting_parameters->target_altitude);
}
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_sv_cam_targeting_parameters_send(chan, sv_cam_targeting_parameters->stream_name, sv_cam_targeting_parameters->cam_id, sv_cam_targeting_parameters->targeting_mode, sv_cam_targeting_parameters->euler_delta, sv_cam_targeting_parameters->yaw, sv_cam_targeting_parameters->pitch, sv_cam_targeting_parameters->roll, sv_cam_targeting_parameters->lock_flags, sv_cam_targeting_parameters->x_offset, sv_cam_targeting_parameters->y_offset, sv_cam_targeting_parameters->target_latitude, sv_cam_targeting_parameters->target_longitude, sv_cam_targeting_parameters->target_altitude);
#else
...
{
    return _MAV_RETURN_char_array(msg, stream_name, 16,  32);
}
