...
{
    return mavlink_msg_sv_detection_parameters_pack(system_id, component_id, msg, sv_detection_parameters->mode, sv_detection_parameters->sorting_mode, sv_detection_parameters->crop_confidence_threshold, sv_detection_parameters->var_confidence_threshold, sv_detection_parameters->crop_box_limit, sv_detection_parameters->var_box_limit, sv_detection_parameters->crop_box_overlap, sv_detection_parameters->var_box_overlap, sv_detection_parameters->creation_score_scale, sv_detection_parameters->bonus_detection_scale, sv_detection_parameters->bonus_redetection_scale, sv_detection_parameters->missed_detection_penalty, sv_detection_parameters->missed_redetection_penalty);
}
...
{
    return mavlink_msg_sv_detection_parameters_pack_chan(system_id, component_id, chan, msg, sv_detection_parameters->mode, sv_detection_parameters->sorting_mode, sv_detection_parameters->crop_confidence_threshold, sv_detection_parameters->var_confidence_threshold, sv_detection_parameters->crop_box_limit, sv_detection_parameters->var_box_limit, sv_detection_parameters->crop_box_overlap, sv_detection_parameters->var_box_overlap, sv_detection_parameters->creation_score_scale, sv_detection_parameters->bonus_detection_scale, sv_detection_parameters->bonus_redetection_scale, sv_detection_parameters->missed_detection_penalty, sv_detection_parameters->missed_redetection_penalty);
}
...
{
    return mavlink_msg_sv_detection_parameters_pack_status(system_id, component_id, _status, msg,  sv_detection_parameters->mode, sv_detection_parameters->sorting_mode, sv_detection_parameters->crop_confidence_threshold, sv_detection_parameters->var_confidence_threshold, sv_detection_parameters->crop_box_limit, sv_detection_parameters->var_box_limit, sv_detection_parameters->crop_box_overlap, sv_detection_parameters->var_box_overlap, sv_detection_parameters->creation_score_scale, sv_detection_parameters->bonus_detection_scale, sv_detection_parameters->bonus_redetection_scale, sv_detection_parameters->missed_detection_penalty, sv_detection_parameters->missed_redetection_penalty);
}
...
static inline void mavlink_msg_sv_detection_parameters_send(mavlink_channel_t chan, uint8_t mode, uint8_t sorting_mode, float crop_confidence_threshold, float var_confidence_threshold, uint16_t crop_box_limit, uint16_t var_box_limit, float crop_box_overlap, float var_box_overlap, uint8_t creation_score_scale, uint8_t bonus_detection_scale, uint8_t bonus_redetection_scale, uint8_t missed_detection_penalty, uint8_t missed_redetection_penalty)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_SV_DETECTION_PARAMETERS_LEN];
    _mav_put_float(buf, 0, crop_confidence_threshold);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_sv_detection_parameters_send(chan, sv_detection_parameters->mode, sv_detection_parameters->sorting_mode, sv_detection_parameters->crop_confidence_threshold, sv_detection_parameters->var_confidence_threshold, sv_detection_parameters->crop_box_limit, sv_detection_parameters->var_box_limit, sv_detection_parameters->crop_box_overlap, sv_detection_parameters->var_box_overlap, sv_detection_parameters->creation_score_scale, sv_detection_parameters->bonus_detection_scale, sv_detection_parameters->bonus_redetection_scale, sv_detection_parameters->missed_detection_penalty, sv_detection_parameters->missed_redetection_penalty);
#else
 ...
 */
static inline void mavlink_msg_sv_detection_parameters_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t mode, uint8_t sorting_mode, float crop_confidence_threshold, float var_confidence_threshold, uint16_t crop_box_limit, uint16_t var_box_limit, float crop_box_overlap, float var_box_overlap, uint8_t creation_score_scale, uint8_t bonus_detection_scale, uint8_t bonus_redetection_scale, uint8_t missed_detection_penalty, uint8_t missed_redetection_penalty)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
