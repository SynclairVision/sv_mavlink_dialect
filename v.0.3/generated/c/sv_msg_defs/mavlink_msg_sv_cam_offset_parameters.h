...
#define MAVLINK_MSG_ID_SV_CAM_OFFSET_PARAMETERS_LEN 41
#define MAVLINK_MSG_ID_SV_CAM_OFFSET_PARAMETERS_MIN_LEN 41
#define MAVLINK_MSG_ID_40009_LEN 41
#define MAVLINK_MSG_ID_40009_MIN_LEN 41

#define MAVLINK_MSG_ID_SV_CAM_OFFSET_PARAMETERS_CRC 123
#define MAVLINK_MSG_ID_40009_CRC 123

#define MAVLINK_MSG_SV_CAM_OFFSET_PARAMETERS_FIELD_STREAM_NAME_LEN 16
...
#define MAVLINK_MESSAGE_INFO_SV_CAM_OFFSET_PARAMETERS { \
    ...
    8, \
    {  { "stream_name", NULL, MAVLINK_TYPE_CHAR, 16, 24, offsetof(mavlink_sv_cam_offset_parameters_t, stream_name) }, \
         { "cam_id", NULL, MAVLINK_TYPE_UINT8_T, 0, 40, offsetof(mavlink_sv_cam_offset_parameters_t, cam_id) }, \
                               ...
                               const char *stream_name, uint8_t cam_id, float x, float y, float yaw_abs, float pitch_abs, float yaw_rel, float pitch_rel)
{
    ...
    _mav_put_char_array(buf, 24, stream_name, 16);
...
{
    return mavlink_msg_sv_cam_offset_parameters_pack(system_id, component_id, msg, sv_cam_offset_parameters->stream_name, sv_cam_offset_parameters->cam_id, sv_cam_offset_parameters->x, sv_cam_offset_parameters->y, sv_cam_offset_parameters->yaw_abs, sv_cam_offset_parameters->pitch_abs, sv_cam_offset_parameters->yaw_rel, sv_cam_offset_parameters->pitch_rel);
}
...
{
    return mavlink_msg_sv_cam_offset_parameters_pack_chan(system_id, component_id, chan, msg, sv_cam_offset_parameters->stream_name, sv_cam_offset_parameters->cam_id, sv_cam_offset_parameters->x, sv_cam_offset_parameters->y, sv_cam_offset_parameters->yaw_abs, sv_cam_offset_parameters->pitch_abs, sv_cam_offset_parameters->yaw_rel, sv_cam_offset_parameters->pitch_rel);
}
...
{
    return mavlink_msg_sv_cam_offset_parameters_pack_status(system_id, component_id, _status, msg,  sv_cam_offset_parameters->stream_name, sv_cam_offset_parameters->cam_id, sv_cam_offset_parameters->x, sv_cam_offset_parameters->y, sv_cam_offset_parameters->yaw_abs, sv_cam_offset_parameters->pitch_abs, sv_cam_offset_parameters->yaw_rel, sv_cam_offset_parameters->pitch_rel);
}
...
static inline void mavlink_msg_sv_cam_offset_parameters_send(mavlink_channel_t chan, const char *stream_name, uint8_t cam_id, float x, float y, float yaw_abs, float pitch_abs, float yaw_rel, float pitch_rel)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_SV_CAM_OFFSET_PARAMETERS_LEN];
    _mav_put_float(buf, 0, x);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_sv_cam_offset_parameters_send(chan, sv_cam_offset_parameters->stream_name, sv_cam_offset_parameters->cam_id, sv_cam_offset_parameters->x, sv_cam_offset_parameters->y, sv_cam_offset_parameters->yaw_abs, sv_cam_offset_parameters->pitch_abs, sv_cam_offset_parameters->yaw_rel, sv_cam_offset_parameters->pitch_rel);
#else
 ...
 */
static inline void mavlink_msg_sv_cam_offset_parameters_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  const char *stream_name, uint8_t cam_id, float x, float y, float yaw_abs, float pitch_abs, float yaw_rel, float pitch_rel)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
{
    return _MAV_RETURN_char_array(msg, stream_name, 16,  24);
}
