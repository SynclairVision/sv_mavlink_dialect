...
#define MAVLINK_MSG_ID_DETECTED_ROI_PARAMETERS_LEN 38
#define MAVLINK_MSG_ID_DETECTED_ROI_PARAMETERS_MIN_LEN 38
#define MAVLINK_MSG_ID_40006_LEN 38
#define MAVLINK_MSG_ID_40006_MIN_LEN 38

#define MAVLINK_MSG_ID_DETECTED_ROI_PARAMETERS_CRC 84
...
#define MAVLINK_MESSAGE_INFO_DETECTED_ROI_PARAMETERS { \
    ...
    13, \
    {  { "index", NULL, MAVLINK_TYPE_UINT8_T, 0, 34, offsetof(mavlink_detected_roi_parameters_t, index) }, \
         { "score", NULL, MAVLINK_TYPE_UINT8_T, 0, 35, offsetof(mavlink_detected_roi_parameters_t, score) }, \
         { "total_detections", NULL, MAVLINK_TYPE_UINT8_T, 0, 36, offsetof(mavlink_detected_roi_parameters_t, total_detections) }, \
         { "type", NULL, MAVLINK_TYPE_INT16_T, 0, 32, offsetof(mavlink_detected_roi_parameters_t, type) }, \
         { "yaw_global", NULL, MAVLINK_TYPE_FLOAT, 0, 0, offsetof(mavlink_detected_roi_parameters_t, yaw_global) }, \
         { "pitch_global", NULL, MAVLINK_TYPE_FLOAT, 0, 4, offsetof(mavlink_detected_roi_parameters_t, pitch_global) }, \
         { "rel_frame_of_reference", NULL, MAVLINK_TYPE_UINT8_T, 0, 37, offsetof(mavlink_detected_roi_parameters_t, rel_frame_of_reference) }, \
...
static inline uint16_t mavlink_msg_detected_roi_parameters_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t index, uint8_t score, uint8_t total_detections, int16_t type, float yaw_global, float pitch_global, uint8_t rel_frame_of_reference, float yaw_rel, float pitch_rel, float latitude, float longitude, float altitude, float distance)
{
 ...
 */
static inline void mavlink_msg_detected_roi_parameters_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t index, uint8_t score, uint8_t total_detections, int16_t type, float yaw_global, float pitch_global, uint8_t rel_frame_of_reference, float yaw_rel, float pitch_rel, float latitude, float longitude, float altitude, float distance)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field type from detected_roi_parameters message
 *
 * @return  Detection class.
 */
static inline int16_t mavlink_msg_detected_roi_parameters_get_type(const mavlink_message_t* msg)
{
    return _MAV_RETURN_int16_t(msg,  32);
}

/**
 * @brief Get field yaw_global from detected_roi_parameters message
 *
 * @return  Global yaw in radians (Tait-Bryan, vs true north).
 */
static inline float mavlink_msg_detected_roi_parameters_get_yaw_global(const mavlink_message_t* msg)
{
    return _MAV_RETURN_float(msg,  0);
}

/**
 * @brief Get field pitch_global from detected_roi_parameters message
 *
 * @return  Global pitch in radians (vs true north).
 */
static inline float mavlink_msg_detected_roi_parameters_get_pitch_global(const mavlink_message_t* msg)
{
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    detected_roi_parameters->yaw_global = mavlink_msg_detected_roi_parameters_get_yaw_global(msg);
    detected_roi_parameters->pitch_global = mavlink_msg_detected_roi_parameters_get_pitch_global(msg);
    ...
    detected_roi_parameters->type = mavlink_msg_detected_roi_parameters_get_type(msg);
