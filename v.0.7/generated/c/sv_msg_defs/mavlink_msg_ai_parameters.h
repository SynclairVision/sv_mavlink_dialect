...
typedef struct __mavlink_ai_parameters_t {
 ...
 char track_model_name[16]; /*<  Name of the verification / tracking model.*/
 char scan_model_name[16]; /*<  Name of the crop (detection) model.*/
...
#define MAVLINK_MSG_ID_AI_PARAMETERS_CRC 221
#define MAVLINK_MSG_ID_40001_CRC 221

#define MAVLINK_MSG_AI_PARAMETERS_FIELD_TRACK_MODEL_NAME_LEN 16
#define MAVLINK_MSG_AI_PARAMETERS_FIELD_SCAN_MODEL_NAME_LEN 16
...
#define MAVLINK_MESSAGE_INFO_AI_PARAMETERS { \
    ...
    {  { "run_ai", NULL, MAVLINK_TYPE_UINT8_T, 0, 0, offsetof(mavlink_ai_parameters_t, run_ai) }, \
         { "track_model_name", NULL, MAVLINK_TYPE_CHAR, 16, 1, offsetof(mavlink_ai_parameters_t, track_model_name) }, \
         { "scan_model_name", NULL, MAVLINK_TYPE_CHAR, 16, 17, offsetof(mavlink_ai_parameters_t, scan_model_name) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_AI_PARAMETERS { \
 ...
 * @param track_model_name  Name of the verification / tracking model.
 * @param scan_model_name  Name of the crop (detection) model.
...
static inline uint16_t mavlink_msg_ai_parameters_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t run_ai, const char *track_model_name, const char *scan_model_name)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_AI_PARAMETERS_LEN];
    _mav_put_uint8_t(buf, 0, run_ai);
    _mav_put_char_array(buf, 1, track_model_name, 16);
    _mav_put_char_array(buf, 17, scan_model_name, 16);
        memcpy(_MAV_PAYLOAD_NON_CONST(msg), buf, MAVLINK_MSG_ID_AI_PARAMETERS_LEN);
#else
    mavlink_ai_parameters_t packet;
    packet.run_ai = run_ai;
    mav_array_memcpy(packet.track_model_name, track_model_name, sizeof(char)*16);
    mav_array_memcpy(packet.scan_model_name, scan_model_name, sizeof(char)*16);
...
{
    return mavlink_msg_ai_parameters_pack(system_id, component_id, msg, ai_parameters->run_ai, ai_parameters->track_model_name, ai_parameters->scan_model_name);
}
...
{
    return mavlink_msg_ai_parameters_pack_chan(system_id, component_id, chan, msg, ai_parameters->run_ai, ai_parameters->track_model_name, ai_parameters->scan_model_name);
}
...
{
    return mavlink_msg_ai_parameters_pack_status(system_id, component_id, _status, msg,  ai_parameters->run_ai, ai_parameters->track_model_name, ai_parameters->scan_model_name);
}
...
static inline void mavlink_msg_ai_parameters_send(mavlink_channel_t chan, uint8_t run_ai, const char *track_model_name, const char *scan_model_name)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_AI_PARAMETERS_LEN];
    _mav_put_uint8_t(buf, 0, run_ai);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_ai_parameters_send(chan, ai_parameters->run_ai, ai_parameters->track_model_name, ai_parameters->scan_model_name);
#else
 ...
 */
static inline void mavlink_msg_ai_parameters_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t run_ai, const char *track_model_name, const char *scan_model_name)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field track_model_name from ai_parameters message
 *
 * @return  Name of the verification / tracking model.
 */
static inline uint16_t mavlink_msg_ai_parameters_get_track_model_name(const mavlink_message_t* msg, char *track_model_name)
{
    return _MAV_RETURN_char_array(msg, track_model_name, 16,  1);
}

/**
 * @brief Get field scan_model_name from ai_parameters message
 *
 * @return  Name of the crop (detection) model.
 */
static inline uint16_t mavlink_msg_ai_parameters_get_scan_model_name(const mavlink_message_t* msg, char *scan_model_name)
{
    return _MAV_RETURN_char_array(msg, scan_model_name, 16,  17);
}
...
static inline void mavlink_msg_ai_parameters_decode(const mavlink_message_t* msg, mavlink_ai_parameters_t* ai_parameters)
{
    ...
    mavlink_msg_ai_parameters_get_track_model_name(msg, ai_parameters->track_model_name);
    mavlink_msg_ai_parameters_get_scan_model_name(msg, ai_parameters->scan_model_name);
#else
