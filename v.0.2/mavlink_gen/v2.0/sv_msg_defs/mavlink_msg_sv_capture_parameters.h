...
typedef struct __mavlink_sv_capture_parameters_t {
 ...
 uint8_t cap_single_image; /*<  1=single still capture.*/
 uint8_t record_video; /*<  1=record video.*/
 char stream_name[8]; /*<  Stream name.*/
} mavlink_sv_capture_parameters_t;

#define MAVLINK_MSG_ID_SV_CAPTURE_PARAMETERS_LEN 14
#define MAVLINK_MSG_ID_SV_CAPTURE_PARAMETERS_MIN_LEN 14
#define MAVLINK_MSG_ID_40004_LEN 14
#define MAVLINK_MSG_ID_40004_MIN_LEN 14

#define MAVLINK_MSG_ID_SV_CAPTURE_PARAMETERS_CRC 174
#define MAVLINK_MSG_ID_40004_CRC 174

#define MAVLINK_MSG_SV_CAPTURE_PARAMETERS_FIELD_STREAM_NAME_LEN 8
...
#define MAVLINK_MESSAGE_INFO_SV_CAPTURE_PARAMETERS { \
    ...
    {  { "images_captured", NULL, MAVLINK_TYPE_UINT16_T, 0, 0, offsetof(mavlink_sv_capture_parameters_t, images_captured) }, \
         ...
         { "cap_single_image", NULL, MAVLINK_TYPE_UINT8_T, 0, 4, offsetof(mavlink_sv_capture_parameters_t, cap_single_image) }, \
         { "record_video", NULL, MAVLINK_TYPE_UINT8_T, 0, 5, offsetof(mavlink_sv_capture_parameters_t, record_video) }, \
         { "stream_name", NULL, MAVLINK_TYPE_CHAR, 8, 6, offsetof(mavlink_sv_capture_parameters_t, stream_name) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_SV_CAPTURE_PARAMETERS { \
...
static inline uint16_t mavlink_msg_sv_capture_parameters_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint16_t images_captured, uint16_t videos_captured, uint8_t cap_single_image, uint8_t record_video, const char *stream_name)
{
    ...
    _mav_put_char_array(buf, 6, stream_name, 8);
...
{
    return mavlink_msg_sv_capture_parameters_pack(system_id, component_id, msg, sv_capture_parameters->images_captured, sv_capture_parameters->videos_captured, sv_capture_parameters->cap_single_image, sv_capture_parameters->record_video, sv_capture_parameters->stream_name);
}
...
{
    return mavlink_msg_sv_capture_parameters_pack_chan(system_id, component_id, chan, msg, sv_capture_parameters->images_captured, sv_capture_parameters->videos_captured, sv_capture_parameters->cap_single_image, sv_capture_parameters->record_video, sv_capture_parameters->stream_name);
}
...
{
    return mavlink_msg_sv_capture_parameters_pack_status(system_id, component_id, _status, msg,  sv_capture_parameters->images_captured, sv_capture_parameters->videos_captured, sv_capture_parameters->cap_single_image, sv_capture_parameters->record_video, sv_capture_parameters->stream_name);
}
...
static inline void mavlink_msg_sv_capture_parameters_send(mavlink_channel_t chan, uint16_t images_captured, uint16_t videos_captured, uint8_t cap_single_image, uint8_t record_video, const char *stream_name)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_SV_CAPTURE_PARAMETERS_LEN];
    _mav_put_uint16_t(buf, 0, images_captured);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_sv_capture_parameters_send(chan, sv_capture_parameters->images_captured, sv_capture_parameters->videos_captured, sv_capture_parameters->cap_single_image, sv_capture_parameters->record_video, sv_capture_parameters->stream_name);
#else
 ...
 */
static inline void mavlink_msg_sv_capture_parameters_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint16_t images_captured, uint16_t videos_captured, uint8_t cap_single_image, uint8_t record_video, const char *stream_name)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static inline uint8_t mavlink_msg_sv_capture_parameters_get_cap_single_image(const mavlink_message_t* msg)
{
 ...
 */
static inline uint8_t mavlink_msg_sv_capture_parameters_get_record_video(const mavlink_message_t* msg)
{
...
{
    return _MAV_RETURN_char_array(msg, stream_name, 8,  6);
}
