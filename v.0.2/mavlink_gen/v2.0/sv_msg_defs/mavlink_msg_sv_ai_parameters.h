...
typedef struct __mavlink_sv_ai_parameters_t {
 uint8_t run_ai; /*<  1 to run AI, 0 to stop.*/
...
#define MAVLINK_MSG_ID_SV_AI_PARAMETERS_CRC 147
#define MAVLINK_MSG_ID_40001_CRC 147
...
#define MAVLINK_MESSAGE_INFO_SV_AI_PARAMETERS { \
    ...
    "SV_AI_PARAMETERS", \
    3, \
    {  { "run_ai", NULL, MAVLINK_TYPE_UINT8_T, 0, 0, offsetof(mavlink_sv_ai_parameters_t, run_ai) }, \
...
static inline void mavlink_msg_sv_ai_parameters_send(mavlink_channel_t chan, uint8_t run_ai, const char *crop_model_name, const char *var_model_name)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_SV_AI_PARAMETERS_LEN];
    _mav_put_uint8_t(buf, 0, run_ai);
 ...
 */
static inline void mavlink_msg_sv_ai_parameters_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t run_ai, const char *crop_model_name, const char *var_model_name)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static inline uint8_t mavlink_msg_sv_ai_parameters_get_run_ai(const mavlink_message_t* msg)
{
