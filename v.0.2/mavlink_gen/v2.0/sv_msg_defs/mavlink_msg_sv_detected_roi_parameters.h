...
static inline uint16_t mavlink_msg_sv_detected_roi_parameters_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               float yaw_abs, float pitch_abs, float yaw_rel, float pitch_rel, float latitude, float longitude, float altitude, float distance, uint8_t index, uint8_t score, uint8_t total_detections)
{
...
{
    return mavlink_msg_sv_detected_roi_parameters_pack(system_id, component_id, msg, sv_detected_roi_parameters->yaw_abs, sv_detected_roi_parameters->pitch_abs, sv_detected_roi_parameters->yaw_rel, sv_detected_roi_parameters->pitch_rel, sv_detected_roi_parameters->latitude, sv_detected_roi_parameters->longitude, sv_detected_roi_parameters->altitude, sv_detected_roi_parameters->distance, sv_detected_roi_parameters->index, sv_detected_roi_parameters->score, sv_detected_roi_parameters->total_detections);
}
...
{
    return mavlink_msg_sv_detected_roi_parameters_pack_chan(system_id, component_id, chan, msg, sv_detected_roi_parameters->yaw_abs, sv_detected_roi_parameters->pitch_abs, sv_detected_roi_parameters->yaw_rel, sv_detected_roi_parameters->pitch_rel, sv_detected_roi_parameters->latitude, sv_detected_roi_parameters->longitude, sv_detected_roi_parameters->altitude, sv_detected_roi_parameters->distance, sv_detected_roi_parameters->index, sv_detected_roi_parameters->score, sv_detected_roi_parameters->total_detections);
}
...
{
    return mavlink_msg_sv_detected_roi_parameters_pack_status(system_id, component_id, _status, msg,  sv_detected_roi_parameters->yaw_abs, sv_detected_roi_parameters->pitch_abs, sv_detected_roi_parameters->yaw_rel, sv_detected_roi_parameters->pitch_rel, sv_detected_roi_parameters->latitude, sv_detected_roi_parameters->longitude, sv_detected_roi_parameters->altitude, sv_detected_roi_parameters->distance, sv_detected_roi_parameters->index, sv_detected_roi_parameters->score, sv_detected_roi_parameters->total_detections);
}
...
static inline void mavlink_msg_sv_detected_roi_parameters_send(mavlink_channel_t chan, float yaw_abs, float pitch_abs, float yaw_rel, float pitch_rel, float latitude, float longitude, float altitude, float distance, uint8_t index, uint8_t score, uint8_t total_detections)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_SV_DETECTED_ROI_PARAMETERS_LEN];
    _mav_put_float(buf, 0, yaw_abs);
 ...
 */
static inline void mavlink_msg_sv_detected_roi_parameters_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  float yaw_abs, float pitch_abs, float yaw_rel, float pitch_rel, float latitude, float longitude, float altitude, float distance, uint8_t index, uint8_t score, uint8_t total_detections)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
