...
#define MAVLINK_MSG_ID_SV_VIDEO_OUTPUT_PARAMETERS_LEN 57
#define MAVLINK_MSG_ID_SV_VIDEO_OUTPUT_PARAMETERS_MIN_LEN 57
#define MAVLINK_MSG_ID_40003_LEN 57
#define MAVLINK_MSG_ID_40003_MIN_LEN 57

#define MAVLINK_MSG_ID_SV_VIDEO_OUTPUT_PARAMETERS_CRC 196
#define MAVLINK_MSG_ID_40003_CRC 196
...
#define MAVLINK_MSG_SV_VIDEO_OUTPUT_PARAMETERS_FIELD_STREAM_NAME_LEN 8
...
#define MAVLINK_MESSAGE_INFO_SV_VIDEO_OUTPUT_PARAMETERS { \
    ...
    15, \
    {  { "views_x", NULL, MAVLINK_TYPE_UINT16_T, 4, 0, offsetof(mavlink_sv_video_output_parameters_t, views_x) }, \
         { "views_y", NULL, MAVLINK_TYPE_UINT16_T, 4, 8, offsetof(mavlink_sv_video_output_parameters_t, views_y) }, \
         { "views_w", NULL, MAVLINK_TYPE_UINT16_T, 4, 16, offsetof(mavlink_sv_video_output_parameters_t, views_w) }, \
         { "views_h", NULL, MAVLINK_TYPE_UINT16_T, 4, 24, offsetof(mavlink_sv_video_output_parameters_t, views_h) }, \
         { "overlay_x", NULL, MAVLINK_TYPE_UINT16_T, 0, 32, offsetof(mavlink_sv_video_output_parameters_t, overlay_x) }, \
         { "overlay_y", NULL, MAVLINK_TYPE_UINT16_T, 0, 34, offsetof(mavlink_sv_video_output_parameters_t, overlay_y) }, \
         { "overlay_w", NULL, MAVLINK_TYPE_UINT16_T, 0, 36, offsetof(mavlink_sv_video_output_parameters_t, overlay_w) }, \
         { "overlay_h", NULL, MAVLINK_TYPE_UINT16_T, 0, 38, offsetof(mavlink_sv_video_output_parameters_t, overlay_h) }, \
         { "width", NULL, MAVLINK_TYPE_UINT16_T, 0, 40, offsetof(mavlink_sv_video_output_parameters_t, width) }, \
         { "height", NULL, MAVLINK_TYPE_UINT16_T, 0, 42, offsetof(mavlink_sv_video_output_parameters_t, height) }, \
         ...
         { "fps", NULL, MAVLINK_TYPE_UINT8_T, 0, 46, offsetof(mavlink_sv_video_output_parameters_t, fps) }, \
         { "layout_mode", NULL, MAVLINK_TYPE_UINT8_T, 0, 47, offsetof(mavlink_sv_video_output_parameters_t, layout_mode) }, \
         { "detection_overlay_mode", NULL, MAVLINK_TYPE_UINT8_T, 0, 48, offsetof(mavlink_sv_video_output_parameters_t, detection_overlay_mode) }, \
         { "stream_name", NULL, MAVLINK_TYPE_CHAR, 8, 49, offsetof(mavlink_sv_video_output_parameters_t, stream_name) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_SV_VIDEO_OUTPUT_PARAMETERS { \
...
static inline uint16_t mavlink_msg_sv_video_output_parameters_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               const uint16_t *views_x, const uint16_t *views_y, const uint16_t *views_w, const uint16_t *views_h, uint16_t overlay_x, uint16_t overlay_y, uint16_t overlay_w, uint16_t overlay_h, uint16_t width, uint16_t height, uint16_t single_detection_size, uint8_t fps, uint8_t layout_mode, uint8_t detection_overlay_mode, const char *stream_name)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_SV_VIDEO_OUTPUT_PARAMETERS_LEN];
    _mav_put_uint16_t(buf, 32, overlay_x);
    _mav_put_uint16_t(buf, 34, overlay_y);
    _mav_put_uint16_t(buf, 36, overlay_w);
    _mav_put_uint16_t(buf, 38, overlay_h);
    _mav_put_uint16_t(buf, 40, width);
    _mav_put_uint16_t(buf, 42, height);
    _mav_put_uint16_t(buf, 44, single_detection_size);
    _mav_put_uint8_t(buf, 46, fps);
    _mav_put_uint8_t(buf, 47, layout_mode);
    _mav_put_uint8_t(buf, 48, detection_overlay_mode);
    _mav_put_uint16_t_array(buf, 0, views_x, 4);
    _mav_put_uint16_t_array(buf, 8, views_y, 4);
    _mav_put_uint16_t_array(buf, 16, views_w, 4);
    _mav_put_uint16_t_array(buf, 24, views_h, 4);
    _mav_put_char_array(buf, 49, stream_name, 8);
...
{
    return mavlink_msg_sv_video_output_parameters_pack(system_id, component_id, msg, sv_video_output_parameters->views_x, sv_video_output_parameters->views_y, sv_video_output_parameters->views_w, sv_video_output_parameters->views_h, sv_video_output_parameters->overlay_x, sv_video_output_parameters->overlay_y, sv_video_output_parameters->overlay_w, sv_video_output_parameters->overlay_h, sv_video_output_parameters->width, sv_video_output_parameters->height, sv_video_output_parameters->single_detection_size, sv_video_output_parameters->fps, sv_video_output_parameters->layout_mode, sv_video_output_parameters->detection_overlay_mode, sv_video_output_parameters->stream_name);
}
...
{
    return mavlink_msg_sv_video_output_parameters_pack_chan(system_id, component_id, chan, msg, sv_video_output_parameters->views_x, sv_video_output_parameters->views_y, sv_video_output_parameters->views_w, sv_video_output_parameters->views_h, sv_video_output_parameters->overlay_x, sv_video_output_parameters->overlay_y, sv_video_output_parameters->overlay_w, sv_video_output_parameters->overlay_h, sv_video_output_parameters->width, sv_video_output_parameters->height, sv_video_output_parameters->single_detection_size, sv_video_output_parameters->fps, sv_video_output_parameters->layout_mode, sv_video_output_parameters->detection_overlay_mode, sv_video_output_parameters->stream_name);
}
...
{
    return mavlink_msg_sv_video_output_parameters_pack_status(system_id, component_id, _status, msg,  sv_video_output_parameters->views_x, sv_video_output_parameters->views_y, sv_video_output_parameters->views_w, sv_video_output_parameters->views_h, sv_video_output_parameters->overlay_x, sv_video_output_parameters->overlay_y, sv_video_output_parameters->overlay_w, sv_video_output_parameters->overlay_h, sv_video_output_parameters->width, sv_video_output_parameters->height, sv_video_output_parameters->single_detection_size, sv_video_output_parameters->fps, sv_video_output_parameters->layout_mode, sv_video_output_parameters->detection_overlay_mode, sv_video_output_parameters->stream_name);
}
...
static inline void mavlink_msg_sv_video_output_parameters_send(mavlink_channel_t chan, const uint16_t *views_x, const uint16_t *views_y, const uint16_t *views_w, const uint16_t *views_h, uint16_t overlay_x, uint16_t overlay_y, uint16_t overlay_w, uint16_t overlay_h, uint16_t width, uint16_t height, uint16_t single_detection_size, uint8_t fps, uint8_t layout_mode, uint8_t detection_overlay_mode, const char *stream_name)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_SV_VIDEO_OUTPUT_PARAMETERS_LEN];
    _mav_put_uint16_t(buf, 32, overlay_x);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_sv_video_output_parameters_send(chan, sv_video_output_parameters->views_x, sv_video_output_parameters->views_y, sv_video_output_parameters->views_w, sv_video_output_parameters->views_h, sv_video_output_parameters->overlay_x, sv_video_output_parameters->overlay_y, sv_video_output_parameters->overlay_w, sv_video_output_parameters->overlay_h, sv_video_output_parameters->width, sv_video_output_parameters->height, sv_video_output_parameters->single_detection_size, sv_video_output_parameters->fps, sv_video_output_parameters->layout_mode, sv_video_output_parameters->detection_overlay_mode, sv_video_output_parameters->stream_name);
#else
 ...
 */
static inline void mavlink_msg_sv_video_output_parameters_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  const uint16_t *views_x, const uint16_t *views_y, const uint16_t *views_w, const uint16_t *views_h, uint16_t overlay_x, uint16_t overlay_y, uint16_t overlay_w, uint16_t overlay_h, uint16_t width, uint16_t height, uint16_t single_detection_size, uint8_t fps, uint8_t layout_mode, uint8_t detection_overlay_mode, const char *stream_name)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
{
    return _MAV_RETURN_uint16_t_array(msg, views_x, 4,  0);
}
...
{
    return _MAV_RETURN_uint16_t_array(msg, views_y, 4,  8);
}
...
{
    return _MAV_RETURN_uint16_t_array(msg, views_w, 4,  16);
}
...
{
    return _MAV_RETURN_uint16_t_array(msg, views_h, 4,  24);
}
...
{
    return _MAV_RETURN_char_array(msg, stream_name, 8,  49);
}
