...
#define MAVLINK_MSG_ID_SV_CAM_DEPTH_ESTIMATION_PARAMETERS_LEN 14
#define MAVLINK_MSG_ID_SV_CAM_DEPTH_ESTIMATION_PARAMETERS_MIN_LEN 14
#define MAVLINK_MSG_ID_40011_LEN 14
#define MAVLINK_MSG_ID_40011_MIN_LEN 14

#define MAVLINK_MSG_ID_SV_CAM_DEPTH_ESTIMATION_PARAMETERS_CRC 184
#define MAVLINK_MSG_ID_40011_CRC 184

#define MAVLINK_MSG_SV_CAM_DEPTH_ESTIMATION_PARAMETERS_FIELD_STREAM_NAME_LEN 8
...
#define MAVLINK_MESSAGE_INFO_SV_CAM_DEPTH_ESTIMATION_PARAMETERS { \
    ...
    {  { "depth", NULL, MAVLINK_TYPE_FLOAT, 0, 0, offsetof(mavlink_sv_cam_depth_estimation_parameters_t, depth) }, \
         { "cam_id", NULL, MAVLINK_TYPE_UINT8_T, 0, 4, offsetof(mavlink_sv_cam_depth_estimation_parameters_t, cam_id) }, \
         { "depth_estimation_mode", NULL, MAVLINK_TYPE_UINT8_T, 0, 5, offsetof(mavlink_sv_cam_depth_estimation_parameters_t, depth_estimation_mode) }, \
         { "stream_name", NULL, MAVLINK_TYPE_CHAR, 8, 6, offsetof(mavlink_sv_cam_depth_estimation_parameters_t, stream_name) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_SV_CAM_DEPTH_ESTIMATION_PARAMETERS { \
...
static inline uint16_t mavlink_msg_sv_cam_depth_estimation_parameters_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               float depth, uint8_t cam_id, uint8_t depth_estimation_mode, const char *stream_name)
{
...
{
    return mavlink_msg_sv_cam_depth_estimation_parameters_pack(system_id, component_id, msg, sv_cam_depth_estimation_parameters->depth, sv_cam_depth_estimation_parameters->cam_id, sv_cam_depth_estimation_parameters->depth_estimation_mode, sv_cam_depth_estimation_parameters->stream_name);
}
...
{
    return mavlink_msg_sv_cam_depth_estimation_parameters_pack_chan(system_id, component_id, chan, msg, sv_cam_depth_estimation_parameters->depth, sv_cam_depth_estimation_parameters->cam_id, sv_cam_depth_estimation_parameters->depth_estimation_mode, sv_cam_depth_estimation_parameters->stream_name);
}
...
{
    return mavlink_msg_sv_cam_depth_estimation_parameters_pack_status(system_id, component_id, _status, msg,  sv_cam_depth_estimation_parameters->depth, sv_cam_depth_estimation_parameters->cam_id, sv_cam_depth_estimation_parameters->depth_estimation_mode, sv_cam_depth_estimation_parameters->stream_name);
}
...
static inline void mavlink_msg_sv_cam_depth_estimation_parameters_send(mavlink_channel_t chan, float depth, uint8_t cam_id, uint8_t depth_estimation_mode, const char *stream_name)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_SV_CAM_DEPTH_ESTIMATION_PARAMETERS_LEN];
    _mav_put_float(buf, 0, depth);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_sv_cam_depth_estimation_parameters_send(chan, sv_cam_depth_estimation_parameters->depth, sv_cam_depth_estimation_parameters->cam_id, sv_cam_depth_estimation_parameters->depth_estimation_mode, sv_cam_depth_estimation_parameters->stream_name);
#else
 ...
 */
static inline void mavlink_msg_sv_cam_depth_estimation_parameters_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  float depth, uint8_t cam_id, uint8_t depth_estimation_mode, const char *stream_name)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
