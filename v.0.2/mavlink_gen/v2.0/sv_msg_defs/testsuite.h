...
static void mavlink_test_sv_video_output_parameters(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_sv_video_output_parameters_t packet_in = {
        { 17235, 17236, 17237, 17238 },{ 17651, 17652, 17653, 17654 },{ 18067, 18068, 18069, 18070 },{ 18483, 18484, 18485, 18486 },18899,19003,19107,19211,19315,19419,19523,15,82,149,"XYZABCD"
    };
    ...
    mavlink_msg_sv_video_output_parameters_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_sv_video_output_parameters_pack(system_id, component_id, &msg , packet1.views_x , packet1.views_y , packet1.views_w , packet1.views_h , packet1.overlay_x , packet1.overlay_y , packet1.overlay_w , packet1.overlay_h , packet1.width , packet1.height , packet1.single_detection_size , packet1.fps , packet1.layout_mode , packet1.detection_overlay_mode , packet1.stream_name );
    mavlink_msg_sv_video_output_parameters_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_sv_video_output_parameters_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.views_x , packet1.views_y , packet1.views_w , packet1.views_h , packet1.overlay_x , packet1.overlay_y , packet1.overlay_w , packet1.overlay_h , packet1.width , packet1.height , packet1.single_detection_size , packet1.fps , packet1.layout_mode , packet1.detection_overlay_mode , packet1.stream_name );
    mavlink_msg_sv_video_output_parameters_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_sv_video_output_parameters_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_sv_video_output_parameters_send(MAVLINK_COMM_1 , packet1.views_x , packet1.views_y , packet1.views_w , packet1.views_h , packet1.overlay_x , packet1.overlay_y , packet1.overlay_w , packet1.overlay_h , packet1.width , packet1.height , packet1.single_detection_size , packet1.fps , packet1.layout_mode , packet1.detection_overlay_mode , packet1.stream_name );
    mavlink_msg_sv_video_output_parameters_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_sv_capture_parameters(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_msg_sv_capture_parameters_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_sv_capture_parameters_pack(system_id, component_id, &msg , packet1.images_captured , packet1.videos_captured , packet1.cap_single_image , packet1.record_video , packet1.stream_name );
    mavlink_msg_sv_capture_parameters_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_sv_capture_parameters_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.images_captured , packet1.videos_captured , packet1.cap_single_image , packet1.record_video , packet1.stream_name );
    mavlink_msg_sv_capture_parameters_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_sv_capture_parameters_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_sv_capture_parameters_send(MAVLINK_COMM_1 , packet1.images_captured , packet1.videos_captured , packet1.cap_single_image , packet1.record_video , packet1.stream_name );
    mavlink_msg_sv_capture_parameters_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_sv_detection_parameters(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_msg_sv_detection_parameters_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_sv_detection_parameters_pack(system_id, component_id, &msg , packet1.crop_confidence_threshold , packet1.var_confidence_threshold , packet1.crop_box_overlap , packet1.var_box_overlap , packet1.crop_box_limit , packet1.var_box_limit , packet1.mode , packet1.sorting_mode , packet1.creation_score_scale , packet1.bonus_detection_scale , packet1.bonus_redetection_scale , packet1.missed_detection_penalty , packet1.missed_redetection_penalty );
    mavlink_msg_sv_detection_parameters_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_sv_detection_parameters_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.crop_confidence_threshold , packet1.var_confidence_threshold , packet1.crop_box_overlap , packet1.var_box_overlap , packet1.crop_box_limit , packet1.var_box_limit , packet1.mode , packet1.sorting_mode , packet1.creation_score_scale , packet1.bonus_detection_scale , packet1.bonus_redetection_scale , packet1.missed_detection_penalty , packet1.missed_redetection_penalty );
    mavlink_msg_sv_detection_parameters_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_sv_detection_parameters_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_sv_detection_parameters_send(MAVLINK_COMM_1 , packet1.crop_confidence_threshold , packet1.var_confidence_threshold , packet1.crop_box_overlap , packet1.var_box_overlap , packet1.crop_box_limit , packet1.var_box_limit , packet1.mode , packet1.sorting_mode , packet1.creation_score_scale , packet1.bonus_detection_scale , packet1.bonus_redetection_scale , packet1.missed_detection_penalty , packet1.missed_redetection_penalty );
    mavlink_msg_sv_detection_parameters_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_sv_detected_roi_parameters(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_msg_sv_detected_roi_parameters_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_sv_detected_roi_parameters_pack(system_id, component_id, &msg , packet1.yaw_abs , packet1.pitch_abs , packet1.yaw_rel , packet1.pitch_rel , packet1.latitude , packet1.longitude , packet1.altitude , packet1.distance , packet1.index , packet1.score , packet1.total_detections );
    mavlink_msg_sv_detected_roi_parameters_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_sv_detected_roi_parameters_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.yaw_abs , packet1.pitch_abs , packet1.yaw_rel , packet1.pitch_rel , packet1.latitude , packet1.longitude , packet1.altitude , packet1.distance , packet1.index , packet1.score , packet1.total_detections );
    mavlink_msg_sv_detected_roi_parameters_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_sv_detected_roi_parameters_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_sv_detected_roi_parameters_send(MAVLINK_COMM_1 , packet1.yaw_abs , packet1.pitch_abs , packet1.yaw_rel , packet1.pitch_rel , packet1.latitude , packet1.longitude , packet1.altitude , packet1.distance , packet1.index , packet1.score , packet1.total_detections );
    mavlink_msg_sv_detected_roi_parameters_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_sv_cam_targeting_parameters(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_sv_cam_targeting_parameters_t packet_in = {
        17.0,45.0,73.0,101.0,129.0,157.0,185.0,213.0,101,168,235,46,"KLMNOPQ"
    };
    ...
    mavlink_msg_sv_cam_targeting_parameters_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_sv_cam_targeting_parameters_pack(system_id, component_id, &msg , packet1.yaw , packet1.pitch , packet1.roll , packet1.x_offset , packet1.y_offset , packet1.target_latitude , packet1.target_longitude , packet1.target_altitude , packet1.cam_id , packet1.targeting_mode , packet1.euler_delta , packet1.lock_flags , packet1.stream_name );
    mavlink_msg_sv_cam_targeting_parameters_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_sv_cam_optics_and_control_parameters(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_msg_sv_cam_optics_and_control_parameters_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_sv_cam_optics_and_control_parameters_pack(system_id, component_id, &msg , packet1.fov , packet1.cam_id , packet1.zoom , packet1.crop_mode , packet1.stream_name );
    mavlink_msg_sv_cam_optics_and_control_parameters_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_sv_cam_optics_and_control_parameters_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.fov , packet1.cam_id , packet1.zoom , packet1.crop_mode , packet1.stream_name );
    mavlink_msg_sv_cam_optics_and_control_parameters_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_sv_cam_optics_and_control_parameters_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_sv_cam_optics_and_control_parameters_send(MAVLINK_COMM_1 , packet1.fov , packet1.cam_id , packet1.zoom , packet1.crop_mode , packet1.stream_name );
    mavlink_msg_sv_cam_optics_and_control_parameters_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_sv_cam_offset_parameters(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_sv_cam_offset_parameters_t packet_in = {
        17.0,45.0,73.0,101.0,129.0,157.0,77,"ZABCDEF"
    };
    ...
    mavlink_msg_sv_cam_offset_parameters_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_sv_cam_offset_parameters_pack(system_id, component_id, &msg , packet1.x , packet1.y , packet1.yaw_abs , packet1.pitch_abs , packet1.yaw_rel , packet1.pitch_rel , packet1.cam_id , packet1.stream_name );
    mavlink_msg_sv_cam_offset_parameters_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_sv_cam_offset_parameters_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.x , packet1.y , packet1.yaw_abs , packet1.pitch_abs , packet1.yaw_rel , packet1.pitch_rel , packet1.cam_id , packet1.stream_name );
    mavlink_msg_sv_cam_offset_parameters_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_sv_cam_offset_parameters_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_sv_cam_offset_parameters_send(MAVLINK_COMM_1 , packet1.x , packet1.y , packet1.yaw_abs , packet1.pitch_abs , packet1.yaw_rel , packet1.pitch_rel , packet1.cam_id , packet1.stream_name );
    mavlink_msg_sv_cam_offset_parameters_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_sv_cam_depth_estimation_parameters(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_msg_sv_cam_depth_estimation_parameters_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_sv_cam_depth_estimation_parameters_pack(system_id, component_id, &msg , packet1.depth , packet1.cam_id , packet1.depth_estimation_mode , packet1.stream_name );
    mavlink_msg_sv_cam_depth_estimation_parameters_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_sv_cam_depth_estimation_parameters_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.depth , packet1.cam_id , packet1.depth_estimation_mode , packet1.stream_name );
    mavlink_msg_sv_cam_depth_estimation_parameters_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_sv_cam_depth_estimation_parameters_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_sv_cam_depth_estimation_parameters_send(MAVLINK_COMM_1 , packet1.depth , packet1.cam_id , packet1.depth_estimation_mode , packet1.stream_name );
    mavlink_msg_sv_cam_depth_estimation_parameters_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
