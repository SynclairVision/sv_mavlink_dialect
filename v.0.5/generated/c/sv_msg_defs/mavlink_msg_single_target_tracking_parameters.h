...
typedef struct __mavlink_single_target_tracking_parameters_t {
 ...
 float yaw_abs; /*<  Absolute yaw of target in radians.*/
 float pitch_abs; /*<  Absolute pitch of target in radians.*/
...
#define MAVLINK_MSG_ID_SINGLE_TARGET_TRACKING_PARAMETERS_LEN 37
#define MAVLINK_MSG_ID_SINGLE_TARGET_TRACKING_PARAMETERS_MIN_LEN 37
#define MAVLINK_MSG_ID_40012_LEN 37
#define MAVLINK_MSG_ID_40012_MIN_LEN 37
...
#define MAVLINK_MESSAGE_INFO_SINGLE_TARGET_TRACKING_PARAMETERS { \
    ...
    11, \
    {  { "command", NULL, MAVLINK_TYPE_UINT8_T, 0, 26, offsetof(mavlink_single_target_tracking_parameters_t, command) }, \
         { "stream_name", NULL, MAVLINK_TYPE_CHAR, 8, 27, offsetof(mavlink_single_target_tracking_parameters_t, stream_name) }, \
         { "cam_id", NULL, MAVLINK_TYPE_UINT8_T, 0, 35, offsetof(mavlink_single_target_tracking_parameters_t, cam_id) }, \
         ...
         { "detection_id", NULL, MAVLINK_TYPE_UINT8_T, 0, 36, offsetof(mavlink_single_target_tracking_parameters_t, detection_id) }, \
         { "zoom_level", NULL, MAVLINK_TYPE_UINT16_T, 0, 24, offsetof(mavlink_single_target_tracking_parameters_t, zoom_level) }, \
         { "yaw_abs", NULL, MAVLINK_TYPE_FLOAT, 0, 8, offsetof(mavlink_single_target_tracking_parameters_t, yaw_abs) }, \
         { "pitch_abs", NULL, MAVLINK_TYPE_FLOAT, 0, 12, offsetof(mavlink_single_target_tracking_parameters_t, pitch_abs) }, \
         { "yaw_rel", NULL, MAVLINK_TYPE_FLOAT, 0, 16, offsetof(mavlink_single_target_tracking_parameters_t, yaw_rel) }, \
         { "pitch_rel", NULL, MAVLINK_TYPE_FLOAT, 0, 20, offsetof(mavlink_single_target_tracking_parameters_t, pitch_rel) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_SINGLE_TARGET_TRACKING_PARAMETERS { \
 ...
 * @param yaw_abs  Absolute yaw of target in radians.
 * @param pitch_abs  Absolute pitch of target in radians.
...
static inline uint16_t mavlink_msg_single_target_tracking_parameters_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t command, const char *stream_name, uint8_t cam_id, float x_offset, float y_offset, uint8_t detection_id, uint16_t zoom_level, float yaw_abs, float pitch_abs, float yaw_rel, float pitch_rel)
{
    ...
    _mav_put_uint16_t(buf, 24, zoom_level);
    _mav_put_uint8_t(buf, 26, command);
    _mav_put_uint8_t(buf, 35, cam_id);
    _mav_put_uint8_t(buf, 36, detection_id);
    _mav_put_char_array(buf, 27, stream_name, 8);
...
static inline void mavlink_msg_single_target_tracking_parameters_send(mavlink_channel_t chan, uint8_t command, const char *stream_name, uint8_t cam_id, float x_offset, float y_offset, uint8_t detection_id, uint16_t zoom_level, float yaw_abs, float pitch_abs, float yaw_rel, float pitch_rel)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_SINGLE_TARGET_TRACKING_PARAMETERS_LEN];
    _mav_put_float(buf, 0, x_offset);
...
{
    return _MAV_RETURN_char_array(msg, stream_name, 8,  27);
}
...
/**
 * @brief Get field yaw_abs from single_target_tracking_parameters message
 *
 * @return  Absolute yaw of target in radians.
 */
static inline float mavlink_msg_single_target_tracking_parameters_get_yaw_abs(const mavlink_message_t* msg)
{
    return _MAV_RETURN_float(msg,  8);
}

/**
 * @brief Get field pitch_abs from single_target_tracking_parameters message
 *
 * @return  Absolute pitch of target in radians.
 */
static inline float mavlink_msg_single_target_tracking_parameters_get_pitch_abs(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_single_target_tracking_parameters_decode(const mavlink_message_t* msg, mavlink_single_target_tracking_parameters_t* single_target_tracking_parameters)
{
    ...
    single_target_tracking_parameters->yaw_abs = mavlink_msg_single_target_tracking_parameters_get_yaw_abs(msg);
    single_target_tracking_parameters->pitch_abs = mavlink_msg_single_target_tracking_parameters_get_pitch_abs(msg);
