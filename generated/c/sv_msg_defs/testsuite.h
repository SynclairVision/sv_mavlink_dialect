...
static void mavlink_test_ai_parameters(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_ai_parameters_t packet1, packet2;
        ...
        mav_array_memcpy(packet1.track_model_name, packet_in.track_model_name, sizeof(char)*16);
        mav_array_memcpy(packet1.scan_model_name, packet_in.scan_model_name, sizeof(char)*16);
    ...
    mavlink_msg_ai_parameters_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_ai_parameters_pack(system_id, component_id, &msg , packet1.run_ai , packet1.track_model_name , packet1.scan_model_name );
    mavlink_msg_ai_parameters_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_ai_parameters_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.run_ai , packet1.track_model_name , packet1.scan_model_name );
    mavlink_msg_ai_parameters_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_ai_parameters_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_ai_parameters_send(MAVLINK_COMM_1 , packet1.run_ai , packet1.track_model_name , packet1.scan_model_name );
    mavlink_msg_ai_parameters_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_detection_parameters(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_detection_parameters_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.track_confidence_threshold = packet_in.track_confidence_threshold;
        packet1.scan_confidence_threshold = packet_in.scan_confidence_threshold;
        packet1.track_box_overlap = packet_in.track_box_overlap;
        packet1.scan_box_overlap = packet_in.scan_box_overlap;
    ...
    mavlink_msg_detection_parameters_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_detection_parameters_pack(system_id, component_id, &msg , packet1.mode , packet1.sorting_mode , packet1.track_confidence_threshold , packet1.scan_confidence_threshold , packet1.track_box_overlap , packet1.scan_box_overlap , packet1.creation_score_scale , packet1.bonus_detection_scale , packet1.bonus_redetection_scale , packet1.missed_detection_penalty , packet1.missed_redetection_penalty );
    mavlink_msg_detection_parameters_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_detection_parameters_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.mode , packet1.sorting_mode , packet1.track_confidence_threshold , packet1.scan_confidence_threshold , packet1.track_box_overlap , packet1.scan_box_overlap , packet1.creation_score_scale , packet1.bonus_detection_scale , packet1.bonus_redetection_scale , packet1.missed_detection_penalty , packet1.missed_redetection_penalty );
    mavlink_msg_detection_parameters_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_detection_parameters_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_detection_parameters_send(MAVLINK_COMM_1 , packet1.mode , packet1.sorting_mode , packet1.track_confidence_threshold , packet1.scan_confidence_threshold , packet1.track_box_overlap , packet1.scan_box_overlap , packet1.creation_score_scale , packet1.bonus_detection_scale , packet1.bonus_redetection_scale , packet1.missed_detection_penalty , packet1.missed_redetection_penalty );
    mavlink_msg_detection_parameters_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_cam_offset_parameters(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_msg_cam_offset_parameters_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_cam_offset_parameters_pack(system_id, component_id, &msg , packet1.stream_name , packet1.cam_id , packet1.x , packet1.y , packet1.yaw_global , packet1.pitch_global , packet1.yaw_rel , packet1.pitch_rel );
    mavlink_msg_cam_offset_parameters_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_cam_offset_parameters_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.stream_name , packet1.cam_id , packet1.x , packet1.y , packet1.yaw_global , packet1.pitch_global , packet1.yaw_rel , packet1.pitch_rel );
    mavlink_msg_cam_offset_parameters_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_cam_offset_parameters_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_cam_offset_parameters_send(MAVLINK_COMM_1 , packet1.stream_name , packet1.cam_id , packet1.x , packet1.y , packet1.yaw_global , packet1.pitch_global , packet1.yaw_rel , packet1.pitch_rel );
    mavlink_msg_cam_offset_parameters_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_calibration_parameters(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_CALIBRATION_PARAMETERS >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_calibration_parameters_t packet_in = {
        5,72,139
    };
    mavlink_calibration_parameters_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.cam_id = packet_in.cam_id;
        packet1.calib_command = packet_in.calib_command;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_CALIBRATION_PARAMETERS_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_CALIBRATION_PARAMETERS_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_calibration_parameters_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_calibration_parameters_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_calibration_parameters_pack(system_id, component_id, &msg , packet1.cam_id , packet1.calib_command , packet1.calib_status );
    mavlink_msg_calibration_parameters_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_calibration_parameters_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.cam_id , packet1.calib_command , packet1.calib_status );
    mavlink_msg_calibration_parameters_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_calibration_parameters_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_calibration_parameters_send(MAVLINK_COMM_1 , packet1.cam_id , packet1.calib_command , packet1.calib_status );
    mavlink_msg_calibration_parameters_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("CALIBRATION_PARAMETERS") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_CALIBRATION_PARAMETERS) != NULL);
#endif
}

static void mavlink_test_navigation_parameters(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_NAVIGATION_PARAMETERS >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_navigation_parameters_t packet_in = {
        17.0
    };
    mavlink_navigation_parameters_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.altitude = packet_in.altitude;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_NAVIGATION_PARAMETERS_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_NAVIGATION_PARAMETERS_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_navigation_parameters_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_navigation_parameters_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_navigation_parameters_pack(system_id, component_id, &msg , packet1.altitude );
    mavlink_msg_navigation_parameters_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_navigation_parameters_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.altitude );
    mavlink_msg_navigation_parameters_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_navigation_parameters_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_navigation_parameters_send(MAVLINK_COMM_1 , packet1.altitude );
    mavlink_msg_navigation_parameters_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("NAVIGATION_PARAMETERS") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_NAVIGATION_PARAMETERS) != NULL);
#endif
}
...
static void mavlink_test_sv_msg_defs(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_test_calibration_parameters(system_id, component_id, last_msg);
    mavlink_test_navigation_parameters(system_id, component_id, last_msg);
}
