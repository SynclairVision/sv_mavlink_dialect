...
typedef struct __mavlink_detection_parameters_t {
 float track_confidence_threshold; /*<  Score threshold when tracking existing objects.*/
 float scan_confidence_threshold; /*<  Score threshold when scanning for new objects.*/
 float track_box_overlap; /*<  Max allowed overlap between crop tracking boxes.*/
 float scan_box_overlap; /*<  Max allowed overlap between var scan boxes.*/
...
#define MAVLINK_MSG_ID_DETECTION_PARAMETERS_CRC 105
#define MAVLINK_MSG_ID_40005_CRC 105
...
#define MAVLINK_MESSAGE_INFO_DETECTION_PARAMETERS { \
    ...
    {  { "mode", NULL, MAVLINK_TYPE_UINT8_T, 0, 16, offsetof(mavlink_detection_parameters_t, mode) }, \
         ...
         { "track_confidence_threshold", NULL, MAVLINK_TYPE_FLOAT, 0, 0, offsetof(mavlink_detection_parameters_t, track_confidence_threshold) }, \
         { "scan_confidence_threshold", NULL, MAVLINK_TYPE_FLOAT, 0, 4, offsetof(mavlink_detection_parameters_t, scan_confidence_threshold) }, \
         { "track_box_overlap", NULL, MAVLINK_TYPE_FLOAT, 0, 8, offsetof(mavlink_detection_parameters_t, track_box_overlap) }, \
         { "scan_box_overlap", NULL, MAVLINK_TYPE_FLOAT, 0, 12, offsetof(mavlink_detection_parameters_t, scan_box_overlap) }, \
 ...
 * @param track_confidence_threshold  Score threshold when tracking existing objects.
 * @param scan_confidence_threshold  Score threshold when scanning for new objects.
 * @param track_box_overlap  Max allowed overlap between crop tracking boxes.
 * @param scan_box_overlap  Max allowed overlap between var scan boxes.
...
static inline uint16_t mavlink_msg_detection_parameters_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t mode, uint8_t sorting_mode, float track_confidence_threshold, float scan_confidence_threshold, float track_box_overlap, float scan_box_overlap, uint8_t creation_score_scale, uint8_t bonus_detection_scale, uint8_t bonus_redetection_scale, uint8_t missed_detection_penalty, uint8_t missed_redetection_penalty)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_DETECTION_PARAMETERS_LEN];
    _mav_put_float(buf, 0, track_confidence_threshold);
    _mav_put_float(buf, 4, scan_confidence_threshold);
    _mav_put_float(buf, 8, track_box_overlap);
    _mav_put_float(buf, 12, scan_box_overlap);
    ...
    packet.track_confidence_threshold = track_confidence_threshold;
    packet.scan_confidence_threshold = scan_confidence_threshold;
    packet.track_box_overlap = track_box_overlap;
    packet.scan_box_overlap = scan_box_overlap;
    packet.mode = mode;
...
static inline void mavlink_msg_detection_parameters_send(mavlink_channel_t chan, uint8_t mode, uint8_t sorting_mode, float track_confidence_threshold, float scan_confidence_threshold, float track_box_overlap, float scan_box_overlap, uint8_t creation_score_scale, uint8_t bonus_detection_scale, uint8_t bonus_redetection_scale, uint8_t missed_detection_penalty, uint8_t missed_redetection_penalty)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_DETECTION_PARAMETERS_LEN];
    _mav_put_float(buf, 0, track_confidence_threshold);
 ...
 */
static inline void mavlink_msg_detection_parameters_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t mode, uint8_t sorting_mode, float track_confidence_threshold, float scan_confidence_threshold, float track_box_overlap, float scan_box_overlap, uint8_t creation_score_scale, uint8_t bonus_detection_scale, uint8_t bonus_redetection_scale, uint8_t missed_detection_penalty, uint8_t missed_redetection_penalty)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field track_confidence_threshold from detection_parameters message
 *
 * @return  Score threshold when tracking existing objects.
 */
static inline float mavlink_msg_detection_parameters_get_track_confidence_threshold(const mavlink_message_t* msg)
{
    return _MAV_RETURN_float(msg,  0);
}

/**
 * @brief Get field scan_confidence_threshold from detection_parameters message
 *
 * @return  Score threshold when scanning for new objects.
 */
static inline float mavlink_msg_detection_parameters_get_scan_confidence_threshold(const mavlink_message_t* msg)
{
    return _MAV_RETURN_float(msg,  4);
}

/**
 * @brief Get field track_box_overlap from detection_parameters message
 *
 * @return  Max allowed overlap between crop tracking boxes.
 */
static inline float mavlink_msg_detection_parameters_get_track_box_overlap(const mavlink_message_t* msg)
{
    return _MAV_RETURN_float(msg,  8);
}

/**
 * @brief Get field scan_box_overlap from detection_parameters message
 *
 * @return  Max allowed overlap between var scan boxes.
 */
static inline float mavlink_msg_detection_parameters_get_scan_box_overlap(const mavlink_message_t* msg)
{
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    detection_parameters->track_confidence_threshold = mavlink_msg_detection_parameters_get_track_confidence_threshold(msg);
    detection_parameters->scan_confidence_threshold = mavlink_msg_detection_parameters_get_scan_confidence_threshold(msg);
    detection_parameters->track_box_overlap = mavlink_msg_detection_parameters_get_track_box_overlap(msg);
    detection_parameters->scan_box_overlap = mavlink_msg_detection_parameters_get_scan_box_overlap(msg);
