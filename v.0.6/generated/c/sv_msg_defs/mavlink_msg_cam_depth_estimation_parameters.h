...
#define MAVLINK_MSG_ID_CAM_DEPTH_ESTIMATION_PARAMETERS 40011


typedef struct __mavlink_cam_depth_estimation_parameters_t {
 float depth; /*<  Depth value / parameter (implementation-specific).*/
...
#define MAVLINK_MSG_ID_CAM_DEPTH_ESTIMATION_PARAMETERS_LEN 14
#define MAVLINK_MSG_ID_CAM_DEPTH_ESTIMATION_PARAMETERS_MIN_LEN 14
#define MAVLINK_MSG_ID_40011_LEN 14
#define MAVLINK_MSG_ID_40011_MIN_LEN 14

#define MAVLINK_MSG_ID_CAM_DEPTH_ESTIMATION_PARAMETERS_CRC 180
#define MAVLINK_MSG_ID_40011_CRC 180

#define MAVLINK_MSG_CAM_DEPTH_ESTIMATION_PARAMETERS_FIELD_STREAM_NAME_LEN 8
...
#define MAVLINK_MESSAGE_INFO_CAM_DEPTH_ESTIMATION_PARAMETERS { \
    ...
    4, \
    {  { "stream_name", NULL, MAVLINK_TYPE_CHAR, 8, 4, offsetof(mavlink_cam_depth_estimation_parameters_t, stream_name) }, \
         { "cam_id", NULL, MAVLINK_TYPE_UINT8_T, 0, 12, offsetof(mavlink_cam_depth_estimation_parameters_t, cam_id) }, \
         { "depth_estimation_mode", NULL, MAVLINK_TYPE_UINT8_T, 0, 13, offsetof(mavlink_cam_depth_estimation_parameters_t, depth_estimation_mode) }, \
 ...
 * @param depth  Depth value / parameter (implementation-specific).
                               ...
                               const char *stream_name, uint8_t cam_id, uint8_t depth_estimation_mode, float depth)
{
    ...
    _mav_put_uint8_t(buf, 13, depth_estimation_mode);
...
{
    return mavlink_msg_cam_depth_estimation_parameters_pack(system_id, component_id, msg, cam_depth_estimation_parameters->stream_name, cam_depth_estimation_parameters->cam_id, cam_depth_estimation_parameters->depth_estimation_mode, cam_depth_estimation_parameters->depth);
}
...
{
    return mavlink_msg_cam_depth_estimation_parameters_pack_chan(system_id, component_id, chan, msg, cam_depth_estimation_parameters->stream_name, cam_depth_estimation_parameters->cam_id, cam_depth_estimation_parameters->depth_estimation_mode, cam_depth_estimation_parameters->depth);
}
...
{
    return mavlink_msg_cam_depth_estimation_parameters_pack_status(system_id, component_id, _status, msg,  cam_depth_estimation_parameters->stream_name, cam_depth_estimation_parameters->cam_id, cam_depth_estimation_parameters->depth_estimation_mode, cam_depth_estimation_parameters->depth);
}
...
static inline void mavlink_msg_cam_depth_estimation_parameters_send(mavlink_channel_t chan, const char *stream_name, uint8_t cam_id, uint8_t depth_estimation_mode, float depth)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_CAM_DEPTH_ESTIMATION_PARAMETERS_LEN];
    _mav_put_float(buf, 0, depth);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_cam_depth_estimation_parameters_send(chan, cam_depth_estimation_parameters->stream_name, cam_depth_estimation_parameters->cam_id, cam_depth_estimation_parameters->depth_estimation_mode, cam_depth_estimation_parameters->depth);
#else
 ...
 */
static inline void mavlink_msg_cam_depth_estimation_parameters_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  const char *stream_name, uint8_t cam_id, uint8_t depth_estimation_mode, float depth)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field stream_name from cam_depth_estimation_parameters message
 *
 * @return  Stream name (max 8 characters).
 */
static inline uint16_t mavlink_msg_cam_depth_estimation_parameters_get_stream_name(const mavlink_message_t* msg, char *stream_name)
{
 ...
 *
 * @return  Depth value / parameter (implementation-specific).
 */
...
static inline void mavlink_msg_cam_depth_estimation_parameters_decode(const mavlink_message_t* msg, mavlink_cam_depth_estimation_parameters_t* cam_depth_estimation_parameters)
{
    ...
    mavlink_msg_cam_depth_estimation_parameters_get_stream_name(msg, cam_depth_estimation_parameters->stream_name);
