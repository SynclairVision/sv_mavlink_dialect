...
#define MAVLINK_MSG_ID_SYSTEM_STATUS_PARAMETERS_LEN 2
#define MAVLINK_MSG_ID_SYSTEM_STATUS_PARAMETERS_MIN_LEN 2
#define MAVLINK_MSG_ID_40000_LEN 2
#define MAVLINK_MSG_ID_40000_MIN_LEN 2

#define MAVLINK_MSG_ID_SYSTEM_STATUS_PARAMETERS_CRC 83
#define MAVLINK_MSG_ID_40000_CRC 83
...
#define MAVLINK_MESSAGE_INFO_SYSTEM_STATUS_PARAMETERS { \
    ...
    2, \
    {  { "status", NULL, MAVLINK_TYPE_UINT8_T, 0, 0, offsetof(mavlink_system_status_parameters_t, status) }, \
         { "error", NULL, MAVLINK_TYPE_UINT8_T, 0, 1, offsetof(mavlink_system_status_parameters_t, error) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_SYSTEM_STATUS_PARAMETERS { \
...
{
    return mavlink_msg_system_status_parameters_pack(system_id, component_id, msg, system_status_parameters->status, system_status_parameters->error);
}
...
{
    return mavlink_msg_system_status_parameters_pack_chan(system_id, component_id, chan, msg, system_status_parameters->status, system_status_parameters->error);
}
...
{
    return mavlink_msg_system_status_parameters_pack_status(system_id, component_id, _status, msg,  system_status_parameters->status, system_status_parameters->error);
}
...
static inline void mavlink_msg_system_status_parameters_send(mavlink_channel_t chan, uint8_t status, uint8_t error)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_SYSTEM_STATUS_PARAMETERS_LEN];
    _mav_put_uint8_t(buf, 0, status);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_system_status_parameters_send(chan, system_status_parameters->status, system_status_parameters->error);
#else
 ...
 */
static inline void mavlink_msg_system_status_parameters_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t status, uint8_t error)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
