...
#define MAVLINK_MSG_ID_VIDEO_OUTPUT_PARAMETERS_LEN 57
#define MAVLINK_MSG_ID_VIDEO_OUTPUT_PARAMETERS_MIN_LEN 57
#define MAVLINK_MSG_ID_40003_LEN 57
#define MAVLINK_MSG_ID_40003_MIN_LEN 57

#define MAVLINK_MSG_ID_VIDEO_OUTPUT_PARAMETERS_CRC 44
#define MAVLINK_MSG_ID_40003_CRC 44
 ...
 * @param detection_overlay_x  
        X coordinate (top-left) of the entire detection overlay area in pixels.
      
 * @param detection_overlay_y  
        Y coordinate (top-left) of the entire detection overlay area in pixels.
      
 * @param detection_overlay_w  
        Width in pixels of the entire detection overlay area.
      
 * @param detection_overlay_h  
        Height in pixels of the entire detection overlay area.
      
 * @param single_detection_size  
        Side length in pixels of a single detection camera (detections are square tiles).
...
static inline uint16_t mavlink_msg_video_output_parameters_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               const char *stream_name, uint16_t width, uint16_t height, uint8_t fps, uint8_t layout_mode, uint8_t detection_overlay_mode, const uint16_t *views_x, const uint16_t *views_y, const uint16_t *views_w, const uint16_t *views_h, uint16_t detection_overlay_x, uint16_t detection_overlay_y, uint16_t detection_overlay_w, uint16_t detection_overlay_h, uint16_t single_detection_size)
{
