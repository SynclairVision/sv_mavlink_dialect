...
#define MAVLINK_MSG_ID_DETECTION_PARAMETERS_LEN 27
#define MAVLINK_MSG_ID_DETECTION_PARAMETERS_MIN_LEN 27
#define MAVLINK_MSG_ID_40005_LEN 27
#define MAVLINK_MSG_ID_40005_MIN_LEN 27

#define MAVLINK_MSG_ID_DETECTION_PARAMETERS_CRC 118
#define MAVLINK_MSG_ID_40005_CRC 118
...
#define MAVLINK_MESSAGE_INFO_DETECTION_PARAMETERS { \
    ...
    13, \
    {  { "mode", NULL, MAVLINK_TYPE_UINT8_T, 0, 20, offsetof(mavlink_detection_parameters_t, mode) }, \
         { "sorting_mode", NULL, MAVLINK_TYPE_UINT8_T, 0, 21, offsetof(mavlink_detection_parameters_t, sorting_mode) }, \
         ...
         { "crop_box_limit", NULL, MAVLINK_TYPE_UINT16_T, 0, 16, offsetof(mavlink_detection_parameters_t, crop_box_limit) }, \
         { "var_box_limit", NULL, MAVLINK_TYPE_UINT16_T, 0, 18, offsetof(mavlink_detection_parameters_t, var_box_limit) }, \
         ...
         { "creation_score_scale", NULL, MAVLINK_TYPE_UINT8_T, 0, 22, offsetof(mavlink_detection_parameters_t, creation_score_scale) }, \
         { "bonus_detection_scale", NULL, MAVLINK_TYPE_UINT8_T, 0, 23, offsetof(mavlink_detection_parameters_t, bonus_detection_scale) }, \
         { "bonus_redetection_scale", NULL, MAVLINK_TYPE_UINT8_T, 0, 24, offsetof(mavlink_detection_parameters_t, bonus_redetection_scale) }, \
         { "missed_detection_penalty", NULL, MAVLINK_TYPE_UINT8_T, 0, 25, offsetof(mavlink_detection_parameters_t, missed_detection_penalty) }, \
         { "missed_redetection_penalty", NULL, MAVLINK_TYPE_UINT8_T, 0, 26, offsetof(mavlink_detection_parameters_t, missed_redetection_penalty) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_DETECTION_PARAMETERS { \
 ...
 * @param crop_confidence_threshold  
        Confidence threshold for considering detections while tracking existing objects; range [0.0,0.99).
      
 * @param var_confidence_threshold  
        Confidence threshold for considering detections while scanning for new objects; range [0.0,0.99).
      
 * @param crop_box_limit  
        Deprecated maximum number of crop boxes; typically kept for backwards compatibility.
      
 * @param var_box_limit  
        Deprecated maximum number of VAR boxes; typically kept for backwards compatibility.
      
 * @param crop_box_overlap  
        Maximum allowed overlap between detection boxes when tracking; range [0.0,0.99).
      
 * @param var_box_overlap  
        Maximum allowed overlap between detection boxes when scanning for new objects; range [0.0,0.99).
      
 * @param creation_score_scale  
        Scale / initial score for newly created objects. If set to 255, the previous value is kept.
      
 * @param bonus_detection_scale  
        Score bonus when an object is found again during scanning. If set to 255, the previous value is kept.
      
 * @param bonus_redetection_scale  
        Score bonus when an object is found again during tracking. If set to 255, the previous value is kept.
      
 * @param missed_detection_penalty  
        Score penalty when an object is not found during scanning (despite being expected). If set to 255, the previous value is kept.
      
 * @param missed_redetection_penalty  
        Score penalty when an object is not found during tracking. If set to 255, the previous value is kept.
...
static inline uint16_t mavlink_msg_detection_parameters_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t mode, uint8_t sorting_mode, float crop_confidence_threshold, float var_confidence_threshold, uint16_t crop_box_limit, uint16_t var_box_limit, float crop_box_overlap, float var_box_overlap, uint8_t creation_score_scale, uint8_t bonus_detection_scale, uint8_t bonus_redetection_scale, uint8_t missed_detection_penalty, uint8_t missed_redetection_penalty)
{
...
{
    return mavlink_msg_detection_parameters_pack(system_id, component_id, msg, detection_parameters->mode, detection_parameters->sorting_mode, detection_parameters->crop_confidence_threshold, detection_parameters->var_confidence_threshold, detection_parameters->crop_box_limit, detection_parameters->var_box_limit, detection_parameters->crop_box_overlap, detection_parameters->var_box_overlap, detection_parameters->creation_score_scale, detection_parameters->bonus_detection_scale, detection_parameters->bonus_redetection_scale, detection_parameters->missed_detection_penalty, detection_parameters->missed_redetection_penalty);
}
...
static inline void mavlink_msg_detection_parameters_send(mavlink_channel_t chan, uint8_t mode, uint8_t sorting_mode, float crop_confidence_threshold, float var_confidence_threshold, uint16_t crop_box_limit, uint16_t var_box_limit, float crop_box_overlap, float var_box_overlap, uint8_t creation_score_scale, uint8_t bonus_detection_scale, uint8_t bonus_redetection_scale, uint8_t missed_detection_penalty, uint8_t missed_redetection_penalty)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_DETECTION_PARAMETERS_LEN];
    _mav_put_float(buf, 0, crop_confidence_threshold);
 ...
 */
static inline void mavlink_msg_detection_parameters_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t mode, uint8_t sorting_mode, float crop_confidence_threshold, float var_confidence_threshold, uint16_t crop_box_limit, uint16_t var_box_limit, float crop_box_overlap, float var_box_overlap, uint8_t creation_score_scale, uint8_t bonus_detection_scale, uint8_t bonus_redetection_scale, uint8_t missed_detection_penalty, uint8_t missed_redetection_penalty)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field crop_box_limit from detection_parameters message
 *
 * @return  
        Deprecated maximum number of crop boxes; typically kept for backwards compatibility.
      
 */
static inline uint16_t mavlink_msg_detection_parameters_get_crop_box_limit(const mavlink_message_t* msg)
{
    return _MAV_RETURN_uint16_t(msg,  16);
}

/**
 * @brief Get field var_box_limit from detection_parameters message
 *
 * @return  
        Deprecated maximum number of VAR boxes; typically kept for backwards compatibility.
      
 */
static inline uint16_t mavlink_msg_detection_parameters_get_var_box_limit(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_detection_parameters_decode(const mavlink_message_t* msg, mavlink_detection_parameters_t* detection_parameters)
{
    ...
    detection_parameters->crop_box_limit = mavlink_msg_detection_parameters_get_crop_box_limit(msg);
    detection_parameters->var_box_limit = mavlink_msg_detection_parameters_get_var_box_limit(msg);
